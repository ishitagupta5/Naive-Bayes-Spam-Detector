...
data = data.append(dataFrameFromDirectory('/home/ugrads/majors/ishitagupta/CS2104/W13_AI_ML/spam', 'spam'))
data = data.append(dataFrameFromDirectory('/home/ugrads/majors/ishitagupta/CS2104/W13_AI_ML/ham', 'ham'))
...
sample = ['Free iPhone!', "We regret to inform that your paper has been rejected.", "Ishita", "is", "awesome"]
...
# After making predictions, use predict_proba instead of predict
probabilities = classifier.predict_proba(sample_counts)

# Print out the sample emails and their corresponding class predictions and probabilities
